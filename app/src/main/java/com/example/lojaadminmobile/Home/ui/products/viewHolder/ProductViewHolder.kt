...
class ProductViewHolder(private val containerView: View,private val onClickListener: OnClickListener ,private val di: IDependencyInjection , private val context: Context) : ListProductViewHolder(containerView)
{
